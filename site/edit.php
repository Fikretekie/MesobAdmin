...
">
    ...
    border-radius: 10px;width:48%;">
      ...
      <div class="main_part mx-auto mt-2 w-40 p-4" style="background: #FFFFFF;
    border: 2px solid #2C77E7;
    box-shadow: 13px 18px 27px rgba(0, 0, 0, 0.25);
    border-radius: 10px;">
        <form action="update_item.php?id=<?php echo $item['Item']['id'] ?>" method="post">
          <div class="form-group d-flex">
            ...
            <select class="custom-select mr-sm-2 w-50 ml-4" id="Status" name="Status">
          ...
          <div class="form-group w-100 d-flex justify-content-center">
            <button type="submit" class="btn btn-primary" style="background: #88B6E0;
