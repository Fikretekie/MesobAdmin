...
// echo '<pre>';print_r($itsems);echo '</pre>';exit;
  ...
  <div class="container-fluid">
    <header>
      ...
      <div>
        ...
        <a href="cart.php" class="btn btn-primary" style="margin-top: 16px; margin-right: 15px;background: #FFFFFF;color:black">
      ...
      <div class="logout">
        <button onclick="logout()" class="btn btn-primary" style="margin-top: 16px;
            margin-right: 15px;background: #FFFFFF; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 30px;color:black">
          ...
          <?php $count = 0;
            foreach ($items as $item) {
              ...
              <tr>
                ...
                <td><?php echo (isset($item['createdAt'])) ? (new DateTime($item['createdAt']))->format('j F, Y - h:i a') : '' ?></td>
                <td>
  ...
  <script>
    $(document).ready(function() {
      var table = $('#mytable').DataTable();
        ...
        // Function to get data of all checked items on the current page
          ...
          var selectedItems = [];
            $('input.select-item:checked').each(function() {
                ...
                var itemData = {
                    ...
                    isSender: row.find('td:eq(5)').text(),
                    createdAt: row.find('td:eq(6)').text()
                };
      ...
      // Function to get data of all items across all pages
      function getAllData() {
