    ...
    <div class="main_part mx-auto mt-5" style="background: #FFFFFF; box-shadow: 5px 4px 4px rgba(0, 0, 0, 0.25);">
      <div class="d-flex justify-content-end mb-3">
        <button class="btn btn-secondary position-relative">
          Total Users <span class="badge badge-dark"><?= $total_users ?></span>
        </button>
      </div>
        ...
        <tbody>
          ...
          ?>
              <tr>
                ...
                <td><?php echo (isset($user['createdAt'])) ? (new DateTime($user['createdAt']))->format('j F, Y - h:i a') : '-' ?></td>
